...
import car_collection.cars.validators
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[car_collection.cars.validators.year_validation])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=10, validators=[django.core.validators.MinLengthValidator(2), car_collection.cars.validators.raise_error_of_minimum_characters])),
